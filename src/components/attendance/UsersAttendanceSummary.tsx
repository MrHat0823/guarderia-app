//project\src\components\attendance\UsersAttendanceSummary.tsx
...
export function UsersAttendanceSummary() {
  ...
  <div className="p-6">
    ...
    <h2 className="text-2xl font-bold text-mint-700 mb-6">
      Niños sin asistencia <span className="text-gray-500 text-base">({formattedDate})</span>
    </h2>
    ...
    {currentChildren.length === 0 ? (
      ...
      <ul className="space-y-3">
        {currentChildren.map((child) => (
            ...
            {/* Aquí añadimos el ícono junto al nombre del aula */}
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div className="bg-white p-6 rounded-2xl shadow-2xl max-w-md w-full">
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">
            ¿Deseas registrar entrada (<span className="text-mint-700 font-semibold">08:00</span>) y salida (<span className="text-mint-700 font-semibold">15:00</span>) para{' '}
          ...
          <div className="flex justify-end gap-4">
            ...
            <button
              ...
              onClick={async () => {
                ...
                const fecha = formatInTimeZone(selectedDate, 'America/Bogota', 'yyyy-MM-dd')
